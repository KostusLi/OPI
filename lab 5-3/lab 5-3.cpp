...
int main()
{
	...
	case 2: {
		...
		cin >> q;
		while ((static_cast<int>(q) < 192 && static_cast<int>(q) != 168 && static_cast<int>(q) != 184) || static_cast<int>(q) > 255) {
			cout << "Введите символ русского алфавита! : ";
			cin >> q;
		}
		...
		else if ((q_code > 191 && q_code < 224) || q_code == 168) {
			toupperLet_1 = q_code;
			tolowerLet_1 = q_code + 32;
		}
		else if (q_code == 184)
		{
			toupperLet_1 = q_code - 16;
			tolowerLet_1 = q_code;
		}
		else if (q_code == 168)
		{
			toupperLet_1 = q_code;
			tolowerLet_1 = q_code - 16;
		}
